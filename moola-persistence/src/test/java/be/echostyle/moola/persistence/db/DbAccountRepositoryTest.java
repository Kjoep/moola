...
public class DbAccountRepositoryTest extends DbTest {
    ...
    protected void addTestData() {
        ...
        template.execute("insert into accTransaction values('abc1', 'abc123', 'johnny', {ts '2016-2-12 20:00:00'}, 0, 'ringo', 'groceries', -2700, 200, 'I owe you some beers', NULL, 'transfer', NULL, NULL, NULL, NULL, NULL)");
        template.execute("insert into accTransaction values('abc3', '', 'johnny', {ts '2016-2-11 20:00:00'}, 1, 'target', 'groceries', -2100, 200, 'I owe you some nuts', NULL, 'cardPayment', NULL, NULL, NULL, NULL, NULL)");
        template.execute("insert into accTransaction values('abc5', '', 'johnny', {ts '2016-2-12 19:00:00'}, 2, 'ringo', 'salary', 2700, 200, 'Pay', NULL, 'transfer', NULL, NULL, NULL, NULL, NULL)");
        template.execute("insert into accTransaction values('def2', '', 'test', {ts '2016-2-12 20:00:00'}, 3, 'ringo', 'holiday', -620, 200, 'Vegas 17', NULL, 'cardPayment', NULL, NULL, NULL, NULL, NULL)");
        template.execute("insert into accTransaction values('def4', '', 'test', {ts '2016-2-11 20:00:00'}, 4, 'ringo', 'groceries', -20, 200, 'Bought some condoms', NULL, 'cardPayment', NULL, NULL, NULL, NULL, NULL)");
        template.execute("insert into accTransaction values('def6', '', 'test', {ts '2016-2-12 20:00:00'}, 5, 'ringo', 'salary', 1120, 200, 'Pay', NULL, 'transfer', NULL, NULL, NULL, NULL, NULL)");
